...
PROVINCE_RULES_2025: list[dict[str, Any]] = [
    ...
    {'province': '河南', 'batch': '艺术本科批', 'volunteer_mode': '专业+院校', 'school_count': 64, 'major_count_per_school': 1, 'rule_description': '艺术本科批使用统考成绩的专业采用64个「专业+院校」平行志愿填报模式，投档规则与往年一致。'},
    {'province': '河南', 'batch': '艺术专科批', 'volunteer_mode': '专业+院校', 'school_count': 64, 'major_count_per_school': 1, 'rule_description': '艺术专科批采用64个「专业+院校」平行志愿；专科统一使用艺术类公式⑤。'},
    {'province': '河南', 'batch': '体育本科批', 'volunteer_mode': '专业+院校', 'school_count': 64, 'major_count_per_school': 1, 'rule_description': '体育本科批采用64个「专业+院校」平行志愿；综合分按院校公式计算，投档规则与往年一致。'},
    {'province': '河南', 'batch': '体育专科批', 'volunteer_mode': '专业+院校', 'school_count': 64, 'major_count_per_school': 1, 'rule_description': '体育专科批采用64个「专业+院校」平行志愿；专科统一使用体育类公式③。'},
...
def ensure_province_rules_tables() -> None:
